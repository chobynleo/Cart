...
abstract contract CartPoolBase is IPool, ReentrancyGuard, ITokenRecipient {
    ...
    function _stake(
        ...
        if (lockPeriod == 0) {
            ...
            // no nft: nft_weight = 10
            // own nft: nft_weight = 12
            // nftWeightMultiplier = 10
            // uint256 newStakeWeight = oldStakeWeight + _amount * weightMultiplier * nft_weight / nftWeightMultiplier ; 
